...
public class Card implements Serializable{
	...
	public String toString() {
		return "Card [name=" + name + ", temperament=" + temperament + ", origin=" + origin + ", description="
				+ description + ", adaptability=" + adaptability + ", affection_level=" + affection_level
				+ ", child_friendly=" + child_friendly + ", dog_friendly=" + dog_friendly + ", energy_level="
				+ energy_level + ", grooming=" + grooming + ", health_issues=" + health_issues + ", intelligence="
				+ intelligence + ", shedding_level=" + shedding_level + ", social_needs=" + social_needs
				+ ", stranger_friendly=" + stranger_friendly + ", vocalisation=" + vocalisation + ", url=" + url
